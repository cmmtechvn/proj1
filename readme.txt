...
a. Windows hosts: Double-click the VMware Workstation icon on your desktop or use the Start menu (Start > Programs > VMware > VMware Workstation).

b. Linux hosts: In a terminal window, enter the command
...
c. SUSE Linux 9.1 — Start > System > More Programs > VMware Workstation
